	...
	<div id="_boxichManageWrap">
		...
		<form id="login">
			...
			<div>
				...
				<img id="userIcon" src="../wp-content/plugins/boxich/includes/img/user-icon.svg"><input type="text" class="blank" placeholder="Username" name="username">
				<img id="pwdIcon" src="../wp-content/plugins/boxich/includes/img/pwd-icon.svg"><input type="password" class="blank" placeholder="Password" name="password">
				<br>
		...
		<form id="wpRegisterForm">
			<input type="text" required class="blank" placeholder="Name" name="wpRegName">
			<input type="email" required class="blank" placeholder="Email" name="wpRegMail">
